...
CREATE TABLE `Movies`(
	...
	CONSTRAINT `actor_id_fk` FOREIGN KEY (`actor_id`) REFERENCES `Actor` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT `director_id_fk` FOREIGN KEY (`director_id`) REFERENCES `Director` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
